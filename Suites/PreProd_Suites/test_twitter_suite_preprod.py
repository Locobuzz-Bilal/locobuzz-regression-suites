...
MODULE_NAME = "Regression - Twitter Reply Workflow on PreProd"
today_str = time.strftime("%d-%b-%Y").upper()

RAW_TEST_PATHS = [
    "tests/selenium/PreProd/twitter-preprod/test_reply_and_assign.py",
    "tests/selenium/PreProd/twitter-preprod/test_reply_and_await.py",
    "tests/selenium/PreProd/twitter-preprod/test_reply_and_onHold.py",
    "tests/selenium/PreProd/twitter-preprod/test_reply_and_escalate.py",
    "tests/selenium/PreProd/twitter-preprod/test_csd_approve.py",
    "tests/selenium/PreProd/twitter-preprod/test_reply_and_close.py",
    "tests/selenium/PreProd/twitter-preprod/test_otherActions_openTicket.py"
    # "tests/selenium/PreProd/twitter/test_otherActions_closedTicket.py"
]
...
def send_email_html(report_dir: Path, results_dir: Path, duration: float, exit_code: int, timing: TimingCollector):
    ...
    html = build_enterprise_email_html(
        ...
        suite_subtitle="Twitter • PreProd Regression",
    ...
    subject = f"Twitter (PreProd) Suite {today_str}"
    try:
