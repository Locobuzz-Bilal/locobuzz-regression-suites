...
# Selenium scripts (linkedin)
SELENIUM_SCRIPTS = [
    # "tests/selenium/linkedin/test_reply_and_assign.py",
    # "tests/selenium/linkedin/test_reply_and_await.py",
    # "tests/selenium/linkedin/test_reply_and_onHold.py",
    # "tests/selenium/linkedin/test_reply_and_escalate.py",
    # "tests/selenium/linkedin/test_csd_approve.py",
    # "tests/selenium/linkedin/test_reply_and_close.py",
    # "tests/selenium/linkedin/test_otherActions_openTicket.py",
    # "tests/selenium/linkedin/test_otherActions_closedTicket.py",

    "tests/selenium/linkedin/test_linkedin_regression.py"
]
