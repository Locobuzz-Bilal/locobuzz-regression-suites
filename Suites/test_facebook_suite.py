import os, sys, time, glob, shutil, json, re
...
# Test scripts
RAW_TEST_PATHS = [
    # "tests/selenium/facebook/test_reply_and_assign.py",
    # "tests/selenium/facebook/test_reply_and_await.py",
    # "tests/selenium/facebook/test_reply_and_onHold.py",
    # "tests/selenium/facebook/test_reply_and_escalate.py",
    # "tests/selenium/facebook/test_csd_approve.py",
    # "tests/selenium/facebook/test_reply_and_close.py",
    # "tests/selenium/facebook/test_otherActions_openTicket.py",
    # "tests/selenium/facebook/test_otherActions_closedTicket.py"
    "tests/selenium/facebook/test_fb_regression.py"
]
